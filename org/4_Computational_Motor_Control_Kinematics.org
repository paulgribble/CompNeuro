...
equations to visualize how those equally-space joint angles correspond
to cartesian hand positions.
...
The many-to-one mappin issue is directly relevant to current key
...
- Flash, Tamar, and Neville Hogan. "The coordination of arm movements:
  an experimentally confirmed mathematical model." The journal of
  Neuroscience 5, no. 7 (1985): 1688-1703.
