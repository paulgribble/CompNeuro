...
Geogeopoulos and colleagues in the 1980s recorded electrical activity
...
These results have been directly translated into the very applied
problem of using brain activity to control neural prosthetics,
e.g. robotic prosthetic limbs.
