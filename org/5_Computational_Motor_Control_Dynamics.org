...
- Sergio, L. E., Hamel-Pâquet, C., & Kalaska, J. F. (2005). Motor
  cortex neural correlates of output kinematics and kinetics during
  isometric-force and arm-reaching tasks. Journal of neurophysiology,
  94(4), 2353-2378.
...
- Scott, S. H., Gribble, P. L., Graham, K. M., & Cabel,
  D. W. (2001). Dissociation between hand motion and population
  vectors from neural activity in motor cortex. Nature, 413(6852),
  161-164.

- Gribble, P. L., & Scott, S. H. (2002). Overlap of internal models in
  motor cortex for mechanical loads during reaching. Nature,
  417(6892), 938-941.


x maybe representation is mixed
...
x computational modeling shows not unique prediction
...
x models using motor cortex neurons to directly code muscle activation
also predict population-vector coding of hand direction (and other
parameters too)
